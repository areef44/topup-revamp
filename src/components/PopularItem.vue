<template>
    <div class="rounded-md p-2 bg-white dark:border dark:border-gray-700 mt-2 dark:bg-gray-800">
        <div class="">
                ...
                <div class="grid grid-cols-2 gap-x-5 gap-y-4 lg:gap-x-4 lg:gap-x-10 lg:grid-cols-3">
                    <div class="max-w-md p-0 bg-gray-200 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <div class="flex">
                            <div class="bg-black w-1/4 rounded-l-xl">
                                <a href="#">
                                    <img class="rounded-l-xl" src="../assets/thumbnail/ML-64f6.jpeg" alt="" />
                                </a>
                            </div>
                    ...
                    <div class="max-w-md p-0 bg-gray-200 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <div class="flex">
                            <div class="bg-black w-1/4 rounded-l-xl">
                                <a href="#">
                                    <img class="rounded-l-xl" src="../assets/thumbnail/ff-6958.jpeg" alt="" />
                                </a>
                            </div>
                            <div class="w-3/4 rounded-r-xl flex flex-col justify-center items-start text-center px-4">
                    ...
                    <div class="max-w-md p-0 bg-gray-200 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <div class="flex">
                            <div class="bg-black w-1/4 rounded-l-xl">
                                <a href="#">
                                    <img class="rounded-l-xl" src="../assets/thumbnail/pubg.jpeg" alt="" />
                                </a>
                            </div>
                            <div class="w-3/4 rounded-r-xl flex flex-col justify-center items-start text-center px-4">
